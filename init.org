...
;; Moving the cursor over prettified symbols unfolds them.
...
Disable the splash screen and show the init time when opening emacs.
#+BEGIN_SRC emacs-lisp
...
(use-package mingus
  ...
  (progn
    ...
    ;; evil-set-initial-state doesn't work with mingus.
...
(use-package erc
  ...
  (progn
    ...
    (setq erc-autojoin-channels-alist
          '((".*freenode.net" "#emacs" "#emacs-beginners" "#lainchan")
