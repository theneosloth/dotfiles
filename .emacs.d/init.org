...
;; Redraw the display before processing input.
;; This produces smoother scrolling
...
This mode expands keywords into symbols such as \lambda and \ge
#+BEGIN_SRC emacs-lisp
...
(defun git-push-all (commit-message)
  "Create and push a new commit with COMMIT-MESSAGE"
...
(use-package bbdb
  ...
  (progn
    ...
    ;; Do not automatically create entries for the following:
