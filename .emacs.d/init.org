...
(use-package rcirc
  ...
  (progn
    ...
    (setq rcirc-server-alist
          '(("irc.freenode.net" :port 6697 :encryption tls :channels ("#emacs" "#archlinux" "#ipfs" "##linux" "#disroot" "#fsf"))
            ("irc.lainchan.org" :port 6697 :encryption tls :channels ("#lainchan" "#general"))))
